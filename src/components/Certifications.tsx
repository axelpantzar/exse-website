...
export function Certifications() {
  ...
  const items = [
    ...
    {
      src: ucAsset.url,
      label: t({ sv: "UC Högsta kreditvärdighet", en: "UC Highest credit rating" }),
    },
  ];
  ...
  return (
    <section className="mt-28">
      ...
      <ul className="mt-12 grid grid-cols-2 gap-6 rounded-3xl border border-border/70 bg-card p-8 sm:grid-cols-3 md:grid-cols-5 md:p-10">
        {items.map((c) => (
